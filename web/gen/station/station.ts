...
// @generated from protobuf file "station/station.proto" (package "station", syntax proto3)
// tslint:disable
import { ServiceType } from "@protobuf-ts/runtime-rpc";
import { MessageType } from "@protobuf-ts/runtime";
/**
 * @generated from protobuf message station.GetManyStationsRequest
 */
...
/**
 * @generated from protobuf message station.GetManyStationsResponse
 */
export interface GetManyStationsResponse {
    /**
     * @generated from protobuf field: station.PaginatedStation stations = 1;
     */
    stations?: PaginatedStation;
}
/**
 * @generated from protobuf message station.GetOneStationRequest
 */
...
/**
 * @generated from protobuf message station.GetOneStationResponse
 */
export interface GetOneStationResponse {
    /**
     * @generated from protobuf field: station.Station station = 1;
     */
    station?: Station;
}
/**
 * @generated from protobuf message station.SetFavoriteOneStationRequest
 */
...
/**
 * @generated from protobuf message station.SetFavoriteOneStationResponse
 */
export interface SetFavoriteOneStationResponse {
}
/**
 * @generated from protobuf message station.PaginatedStation
 */
export interface PaginatedStation {
    /**
     * @generated from protobuf field: repeated station.Station data = 1;
     */
    data: Station[];
    /**
...
/**
 * @generated from protobuf message station.Station
 */
export interface Station {
    ...
    rgTroncon: number;
    /**
     * @generated from protobuf field: station.Geometry geo_shape = 13;
     */
    geoShape?: Geometry;
    /**
...
/**
 * @generated from protobuf message station.Geometry
 */
...
class GetManyStationsRequest$Type extends MessageType<GetManyStationsRequest> {
    constructor() {
        super("station.GetManyStationsRequest", [
...
/**
 * @generated MessageType for protobuf message station.GetManyStationsRequest
 */
...
class GetManyStationsResponse$Type extends MessageType<GetManyStationsResponse> {
    constructor() {
        super("station.GetManyStationsResponse", [
            { no: 1, name: "stations", kind: "message", T: () => PaginatedStation }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message station.GetManyStationsResponse
 */
...
class GetOneStationRequest$Type extends MessageType<GetOneStationRequest> {
    constructor() {
        super("station.GetOneStationRequest", [
...
/**
 * @generated MessageType for protobuf message station.GetOneStationRequest
 */
...
class GetOneStationResponse$Type extends MessageType<GetOneStationResponse> {
    constructor() {
        super("station.GetOneStationResponse", [
            { no: 1, name: "station", kind: "message", T: () => Station }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message station.GetOneStationResponse
 */
...
class SetFavoriteOneStationRequest$Type extends MessageType<SetFavoriteOneStationRequest> {
    constructor() {
        super("station.SetFavoriteOneStationRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "token", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message station.SetFavoriteOneStationRequest
 */
...
class SetFavoriteOneStationResponse$Type extends MessageType<SetFavoriteOneStationResponse> {
    constructor() {
        super("station.SetFavoriteOneStationResponse", []);
    }
}
/**
 * @generated MessageType for protobuf message station.SetFavoriteOneStationResponse
 */
...
class PaginatedStation$Type extends MessageType<PaginatedStation> {
    constructor() {
        super("station.PaginatedStation", [
...
/**
 * @generated MessageType for protobuf message station.PaginatedStation
 */
...
/**
 * @generated MessageType for protobuf message station.Geometry
 */
export const Geometry = new Geometry$Type();
/**
 * @generated ServiceType for protobuf service station.StationAPI
 */
export const StationAPI = new ServiceType("station.StationAPI", [
