 ...
 *
 * @generated from protobuf service station.StationAPI
 */
export interface IStationAPIClient {
    /**
     * GetManyStations fetch a paginated list of station.
     *
     * @generated from protobuf rpc: GetManyStations(station.GetManyStationsRequest) returns (station.GetManyStationsResponse);
     */
     ...
     *
     * @generated from protobuf rpc: GetOneStation(station.GetOneStationRequest) returns (station.GetOneStationResponse);
     */
     ...
     *
     * @generated from protobuf rpc: SetFavoriteOneStation(station.SetFavoriteOneStationRequest) returns (station.SetFavoriteOneStationResponse);
     */
