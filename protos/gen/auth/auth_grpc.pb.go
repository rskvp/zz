...
const (
	AuthAPI_GetJWT_FullMethodName = "/auth.AuthAPI/GetJWT"
)
...
func (c *authAPIClient) GetJWT(ctx context.Context, in *GetJWTRequest, opts ...grpc.CallOption) (*GetJWTResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_GetJWT_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthAPI_GetJWT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_GetJWT_FullMethodName,
	}
